...
# Run NMF script.
bash /vast/palmer/pi/verhaak/kcj28/care_idh_mut/scripts/snrna/nmf/undifferentiated/downsample/run_nmf_malignant_undifferentiated_downsample.sh ${SLURM_ARRAY_TASK_ID}
