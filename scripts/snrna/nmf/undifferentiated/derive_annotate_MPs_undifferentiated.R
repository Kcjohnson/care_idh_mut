...
nmf_res_dir <- "/vast/palmer/pi/verhaak/kcj28/care_idh_mut/results/nmf_res_caremut/undifferentiated_downsample/"

# List files in the directory - there's 72/75 due the requirement for at least 10 Undifferentiated malignant cells.
...
malignant_undiff_nmf_metaprograms <- derive_NMF_metaprograms(Genes_nmf_w_basis = Genes_nmf_w_basis, 
                                                      save_path = "/vast/palmer/pi/verhaak/kcj28/care_idh_mut/results/metaprograms/undifferentiated_downsampled/", 
