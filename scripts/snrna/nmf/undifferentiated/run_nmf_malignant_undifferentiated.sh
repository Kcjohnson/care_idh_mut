...
# Run Rscript.
Rscript --verbose /vast/palmer/pi/verhaak/kcj28/care_idh_mut/scripts/snrna/nmf/undifferentiated/run_nmf_malignant_state_level.R $IN_PATH $ARRAYID $OUT_PATH $RANK_LB $RANK_UB $NRUN
