...
#SBATCH --error=/vast/palmer/pi/verhaak/kcj28/care_mut/logs/nmf_2026/myeloid_no_parallel/nmf_2026_myeloid_nopar_caremut-%a.err
...
# Run NMF script.
bash /vast/palmer/pi/verhaak/kcj28/care_mut/scripts/nmf_2026/myeloid_no_parallel/run_nmf_myeloid_caremut.sh ${SLURM_ARRAY_TASK_ID}
