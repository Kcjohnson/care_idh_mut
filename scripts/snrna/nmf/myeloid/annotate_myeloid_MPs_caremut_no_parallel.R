...
nmf_res_dir <- "/vast/palmer/pi/verhaak/kcj28/care_mut/results/nmf_res_2026/myeloid_n73_no_parallel/"
...
myeloid_nmf_metaprograms <- derive_NMF_metaprograms(Genes_nmf_w_basis = Genes_nmf_w_basis, 
                                                      save_path = "/vast/palmer/pi/verhaak/kcj28/care_idh_mut/results/metaprograms/myeloid_no_parallel/", 
                                                      verbose = T, 
                                                      n_genes = 50)
