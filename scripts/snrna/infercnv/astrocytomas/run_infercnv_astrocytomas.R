...
counts <- readRDS(paste0("/vast/palmer/pi/verhaak/kcj28/care_mut/processed_data/rna/infercnv_inputs/astrocytomas/",sample_id,"_counts.RDS"))

# Sample-level sample annotation file post QC and cell state assignment.
anno_file <- paste0("/vast/palmer/pi/verhaak/kcj28/care_mut/processed_data/rna/infercnv_inputs/astrocytomas/",sample_id,"_sample_annotation_file.txt")
